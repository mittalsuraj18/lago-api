...
module Subscriptions
  module Dates
    ...
    class BiennialService < Subscriptions::DatesService
      ...
      def compute_base_date
        ...
        modulus_months = total_months_difference % 24
      ...
      def compute_base_end_date
        plus_months = compute_base_date >> 24
        plus_months - 1
      end

      def compute_end_date_calendar
        plus_months_date = compute_base_date >> 24
        plus_month_day_1 = Date.new(plus_months_date.year, plus_months_date.month, 1)
        plus_month_day_1 - 1
      end
